...
mongoimport --host 35.194.236.2 --port 27017 -u root -p wUn9bakXptqo --authenticationDatabase admin --db moviedb --collection movies --type json --file mongo-data/moviedata.json --jsonArray